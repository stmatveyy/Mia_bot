...
async def cmd_start(message: types.Message, database: Database) -> tuple[str,int]:
    approved: int = 0
...
async def num_sent(message: types.Message, bot:Bot, database:Database) -> tuple[str,int]:
...
# async def number_refuse(message: types.Message) -> tuple[str,int]:
#     approved: int = 0
