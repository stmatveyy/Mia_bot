...
yes_remind_button = InlineKeyboardButton(text='Добавить', callback_data='add_time')
...
today_evening = InlineKeyboardButton(text='Сегодня вечером', callback_data='today_evn')

tomorrow_morning = InlineKeyboardButton(text='Завтра утром', callback_data='tomorrow_mor')

in_3_days = InlineKeyboardButton(text='Через три дня', callback_data='days_3')

on_weekend = InlineKeyboardButton(text='На выходных', callback_data='weekend')
